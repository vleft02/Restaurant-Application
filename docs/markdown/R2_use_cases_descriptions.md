...
# ***Τίτλος περίπτωσης χρήσης*:** Διαχείρηση εστιατορίου

<br/>

## ***Πρωτεύων Actor* :** Ιδιοκτήτης

## ***Ενδιαφερόμενοι* :** Ιδιοκτήτης: Θέλει να μπορεί να διαχειρίζεται εύκολα την εφαμοργή του εστιατορίου, να προσθέτει τους υπαλλήλους του στο σύστημα και να μπορεί να βλέπει τα στατιστικά του εστιατορίου του.
...
## ***Προϋποθέσεις* :** Ο ιδιοκτήτης να έχει κάνει είσοδο στην εφαρμογή. Επίσης οι υπάλληλοι να έχουν κάνει εγγραφή στην εφαρμογή και ο ιδιοκτήτης να γνωρίζει τα στοιχεία τους για να τους προσθέσει στο σύστημα.
# **Α) Προσθήκη υπαλλήλου**
## ***Βασική ροή* :**
...
# **B) Πρόσβαση σε στατιστικά στοιχεία**
## ***Βασική ροή* :**
...
> ## 2. Ο πελάτης επιστρέφει στο βήμα 2.
...
## 5. Ο χρήστης ενημερώνεται ότι η δημιουργία του εταιρικού λογαριασμού του εκκρεμμεί επιβεβαίωση απο τον ιδιοκτήτη.
